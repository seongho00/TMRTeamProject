...
addresses = [
    ...
    "서울특별시 양천구 안양천로 1121",  # 양천(예시) - 실제 주소 확인 후 사용
    "서울특별시 노원구 덕릉로 70길 99"       # 노원(예시) - 실제 주소 확인 후 사용
]

# 하수처리장 주소
addresses += [
    "서울특별시 성동구 자동차시장3길 64",  # 중랑물재생센터
    "서울특별시 강남구 개포로 625",        # 탄천물재생센터
    "서울특별시 강서구 양천로 201"         # 서남물재생센터
]

...
df_dir = "C:/Users/admin/Downloads/서울 데이터 모음집"
save_dir_2022 = "C:/Users/admin/Downloads/Seoul_data_2022"
save_dir_2023 = "C:/Users/admin/Downloads/Seoul_data_2023"
save_dir_2024 = "C:/Users/admin/Downloads/Seoul_data_2024"
os.makedirs(save_dir_2022, exist_ok=True)
...
for file_path in csv_files:
    try:
        ...
        if '행정동_코드_명' in df.columns:
            ...
            if '_2022' in filename_lower:
                save_path = os.path.join(save_dir_2022, filename)
                df.to_csv(save_path, index=False, encoding='utf-8-sig')
                print(f"2022 저장: {filename}")

            elif '_2023' in filename_lower:
                ...
                save_path1 = os.path.join(save_dir_2022, filename)
                save_path2 = os.path.join(save_dir_2023, filename)
                save_path3 = os.path.join(save_dir_2024, filename)
                df.to_csv(save_path1, index=False, encoding='utf-8-sig')
                df.to_csv(save_path2, index=False, encoding='utf-8-sig')
                df.to_csv(save_path3, index=False, encoding='utf-8-sig')
...
source_dir = "C:/Users/admin/Downloads/서울 데이터 2025"
target_dir = "C:/Users/admin/Downloads/Seoul_data_2025"

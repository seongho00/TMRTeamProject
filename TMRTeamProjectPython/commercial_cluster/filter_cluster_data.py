...
# 실제 경로로 수정
DATA_DIR = 'C:/Users/user/Downloads/서울 데이터 모음집'
...
# 저장할 폴더 경로 지정 (없으면 생성)
SAVE_DIR = 'C:/Users/user/Downloads/서울 데이터 가공'
...
# 1. 점포 데이터 (2022)
df_2022 = pd.read_csv('C:/Users/user/Downloads/서울 데이터 모음집/서울시 상권분석서비스(점포-행정동)_2022년.csv', encoding='utf-8')
print("✅ 점포 2022년 포함 분기:", sorted(df_2022['기준_년분기_코드'].unique()))

# 2. 추정매출 데이터 (2023)
df_2023 = pd.read_csv('C:/Users/user/Downloads/서울 데이터 모음집/서울시 상권분석서비스(추정매출-행정동)_2023년.csv', encoding='utf-8')
